...
if __name__ == '__main__':
    ...
    parser.add_argument('--risk_free_rate', '-rfr', help='Set the risk-free rate for cost of capital calculations. Defaults to the current 30Y American treasury yield.', type=float)
    parser.add_argument('--market_risk_premium', '-mrp', help='Set the market risk premium for cost of capital calculations (as a decimal). Defaults to the most recent American average MRP as given by Statista.', type=float, default=0.055)
    parser.add_argument('--terminal_growth', '-tg', help='Set the terminal growth rate in the DCF model (as a decimal). Defaults to PricewaterhouseCoopers\' 50Y projected American GDP growth.', type=float, default=0.018050372)
    parser.add_argument('--forecast_years', '-fy', help='Set how many years to make projections for in the DCF mode (as a decimal). Defaults to 5 years.', type=float, default=5)
